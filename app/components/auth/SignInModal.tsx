    ...
    >
      ...
      >
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-600">
            {mode === 'signin'
              ...
              : 'Create an account to track your favorite breaks'}
          </p>
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border-2 border-gray-300 rounded-lg hover:border-gray-400 hover:bg-gray-50 transition font-medium text-gray-700 disabled:opacity-50 disabled:cursor-not-allowed mb-4"
        >
          ...
          {mode === 'signin' ? (
            <>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-ocean-600 text-white py-2.5 rounded-lg hover:bg-ocean-700 transition font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
              >
                {loading ? (
              ...
              <button
                ...
                className="w-full text-ocean-600 hover:text-ocean-700 text-sm font-medium transition disabled:opacity-50"
              >
